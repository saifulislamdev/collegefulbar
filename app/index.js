...
const db = mysql.createConnection({
  // Changed connection set up to work on my own local network
...
app.post("/auth/admin/login", async (req, res) => {
  ...
  administrator
    .verifyAdministratorLogin(email, password, db)
    .then((result) => {
...
app.post("/auth/student/login", async (req, res) => {
  ...
  student
    .verifyStudentLogin(email, password, db)
    .then((result) => {
      req.session.user_name = req.body.email;
      console.log("Logging in the username is: " + req.session.user_name);
      console.log("Password is: ", password);
...
app.post("/auth/instructor/login", async (req, res) => {
  ...
  instructor
    .verifyInstructorLogin(email, password, db)
    .then((result) => {
      req.session.user_name = req.body.email;
      console.log("Logging in the username is: " + req.session.user_name);
      console.log("Password is: ", password);
...
app.post("/auth/register", async (req, res) => {
  ...
  student
    .registerAsStudent(id, name, ssn, email, password, db)
    .then((result) => {
      console.log(result);
      return result;
    })
...
app.post("/auth/ins/register", async (req, res) => {
  ...
  instructor
    .registerAsInstructor(id, name, email, password, db)
    .then((result) => {
      console.log(result);
      return result;
    })
...
app.post("/accountType/submit", (req, res) => {
  ...
  administrator
    .createAccountType(accountType, db)
    .then((result) => {
      return result;
    })
    .then((result) => {
...
app.post("/createDepartment/submit", (req, res) => {
  ...
  administrator
    .createDepartment(id, department, db)
    .then((result) => {
      return result;
    })
    .then((result) => {
...
app.post("/currentSemester/submit", (req, res) => {
  ...
  administrator
    .assignCurrentSemester(name, year, db)
    .then((result) => {
      console.log(result);
      return result;
    })
...
app.post("/nextSemester/submit", (req, res) => {
  ...
  console.log(name, year);
  administrator
    .assignNextSemester(name, year, db)
    .then((result) => {
      console.log(result);
      return result;
    })
...
app.post("/createInstructor/submit", (req, res) => {
  ...
  console.log(name);
  administrator
    .createInstructor(id, name, email, db)
    .then((result) => {
      return result;
    })
    .then((result) => {
...
app.post("/createCourse/submit", (req, res) => {
  ...
  administrator
    .createCourse(id, title, dept, credits, cost, db)
    .then((result) => {
      console.log(result);
      return result;
    })
...
app.post("/updateCourse/submit", (req, res) => {
  ...
  console.log(id, title, dept, credits, cost);
  administrator
    .updateCourse(id, title, dept, credits, cost, db)
    .then((result) => {
      console.log(result);
      return result;
    })
...
app.post("/createClass/submit", (req, res) => {
  ...
  administrator
    .createClass(classId, courseId, section, instructor, year, semester, db)
    .then((result) => {
      console.log(result);
      return result;
    })
...
app.get("/deleteClass/:ClassId", (req, res) => {
  ...
  db.query(sql, async function (err, results) {
    ...
    administrator
      .deleteClass(courseId, section, year, semester, db)
      .then((result) => {
        res.redirect("/createclass");
        console.log(result);
        return result;
...
app.post("/createAdmin/submit", (req, res) => {
  ...
  administrator
    .createAdministratorLogin(email, password, db)
    .then((result) => {
      console.log(result);
      return result;
    })
...
app.post("/enrollClass/submit", (req, res) => {
  ...
  student
    .enrollInClass(classId, courseId, section, year, semester, studentId, db)
    .then((result) => {
      console.log(result);
      return result;
    })
...
app.post("/getid/submit", (req, res) => {
  ...
  let id;
  student
    .getStudentIdFromEmail(email, db)
    .then((result) => {
      console.log(result);
  ...
  app.post("/dropClass/submit", (req, res) => {
    ...
    console.log(classId, courseId, section, year, semester, studentId);
    student
      .dropClass(classId, courseId, section, year, semester, studentId, db)
      .then((result) => {
        console.log(result);
        return result;
      })
...
app.post("/getinsid/submit", (req, res) => {
  ...
  let id;
  instructor
    .getInstructorIdFromEmail(email, db)
    .then((result) => {
      console.log(result);
      id = req.session.user_id = result[1];
      console.log(id);
  ...
  app.get("/view/current/class", (req, res) => {
    console.log(req.session.user_id);
    instructor
      .getMyCurrentlyTaughtClasses(id, db)
      .then((result) => {
        return result;
      })
      .then((result) => {
  ...
  app.post("/assigngrade/submit", (req, res) => {
    ...
    instructor
      .assignGrade(insid, classid, studentid, grade, db)
      .then((result) => {
        console.log(result);
        return result;
      })
